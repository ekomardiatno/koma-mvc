<form action="<?= App\Core\Web::url('admin.group.post') ?>" method="POST">
  <div class="row">
    <div class="col-md-8">
        ...
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            ...
            <div class="col">
              ...
              <h5 class="h3 mb-0">Tambah grup pengguna</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <div class="pl-lg-4">
            <div class="form-group">
              ...
              <input type="text" maxlength="50" id="user_group_name" name='user_group_name' class="form-control" placeholder="Nama grup pengguna">
            </div>
            <div class="form-group">
              <label class="form-control-label" for="user_group_description">Deskripsi grup pengguna</label>
              <textarea rows="4" maxlength="150" name="user_group_description" id="user_group_description" class="form-control" placeholder="Isilah dengan singkat dan jelas (maks. 150 karakter)"></textarea>
            </div>
          </div>
          <hr class="my-4">
          ...
          <div class="pl-lg-4">
              ...
              <div class="card-body bg-secondary" style="height: 150px; overflow: auto;">
                ...
                <?php foreach ($data['controllers'] as $p) : ?>
                  <div class="custom-control custom-checkbox <?= count($data['controllers']) === $no ? '' : 'mb-3' ?>">
                    <input type="checkbox" class="custom-control-input" name="user_group_access[]" value="<?= $p ?>" id="user_group_access_<?= $no ?>">
            ...
            <div class="card mb-0 multi-check">
              ...
              <div class="card-body bg-secondary" style="height: 150px; overflow: auto;">
                ...
                <?php foreach ($data['controllers'] as $p) : ?>
                  <div class="custom-control custom-checkbox <?= count($data['controllers']) === $no ? '' : 'mb-3' ?>">
                    <input type="checkbox" class="custom-control-input" name="user_group_modify[]" value="<?= $p ?>" id="user_group_modify_<?= $no ?>">
            ...
            <div class="card mb-3 multi-check">
              ...
              <div class="card-body bg-secondary" style="height: 150px; overflow: auto;">
                ...
                <?php foreach ($data['controllers'] as $p) : ?>
                  <div class="custom-control custom-checkbox <?= count($data['controllers']) === $no ? '' : 'mb-3' ?>">
                    <input type="checkbox" class="custom-control-input" name="user_group_publish[]" value="<?= $p ?>" id="user_group_publish_<?= $no ?>">
    ...
    <div class="col-md-4">
      <div class="card shadow mb-3">
        <div class="card-body">
          ...
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="status2" name="status" checked value="0" class="custom-control-input">
